    ...
    <div>
        <div class="row">
            ...
            <div class="col-md-2 col-sm-auto col-lg-2 mt-5">
                <img src="https://static.nc-img.com/uiusermanagement/basic-info.3283f958dfae2bddea4cc921923260b6.png" alt="pic" class="bg-primary rounded-pill w-100">
            ...
            <div class="col-md-10 col-sm-auto col-lg-10">
                ...
                <div class="d-flex flex-wrap flex-md-nowrap border-bottom mt-5">
                    ...
                    <button class="btn btn-sm bg-secondary text-white mx-auto mb-2">Edit</button>
                </div>
            </div>
        </div>
    </div>

                    ...
                    <div class="col-lg-6 col-md-4 col-sm-12">
                        <div class="row border border-2 border-primary rounded-2">
                            ...
                            <button
                                ...
                                onclick="document.location='signup.php'">SIGN
                                UP?</button>
                            ...
                            <div class="form-group d-flex flex-row mt-4 ms-4">
                                ...
                                <input type="password" class="form-control w-50 ms-5" id="password"
                                    placeholder="Password" />
                            </div>
                            <div class="text-center">
                                <button type="submit"
                                    class="border border-0 rounded-2 bg-theme p-2 fw-bold text-light mt-4"
                                    onclick="checkLogin()">

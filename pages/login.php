                ...
                <div class="row wow fadeInUp">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-12">
                        <div class="row border border-2 border-primary rounded-2">
                            <div class="col-ld-6 col-md-8 col-sm-12 bg-theme p-3 fw-bold text-light">Log
                                In to Your Account</div>
                            <button class="col-ld-6 col-md-4 col-sm-12 bg-theme p-3 fw-bold text-light text-end border-0" onclick="document.location='signup.php'">SIGN
                                UP?</button>
                            <div class="form-group d-flex flex-row mt-5 ms-4">
                                <label class="fw-bold text-secondary mt-2">Username</label>
                                <input type="text" class="form-control w-50 ms-5" id="name" placeholder="Username" />
                            </div>
                            <div class="form-group d-flex flex-row mt-4 ms-4">
                                <label class="fw-bold text-secondary mt-2">Password</label>
                                <input type="password" class="form-control w-50 ms-5" id="password" placeholder="Password" />
                            </div>
                            <div class="text-center">
                                <button type="submit" class="border border-0 rounded-2 bg-theme p-2 fw-bold text-light mt-4" onclick="checkLogin()">
                                    Sign in and Continue</button>
                            </div>
                            <div class="mt-3 mb-4 text-center">
                                <a href="#" class="text-decoration-none">Forgot username or password?</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-12"></div>
